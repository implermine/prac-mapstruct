package org.example.manual.mapper;

import org.example.manual.model.*;
import org.example.manual.model.builder.BuilderBean;
import org.example.manual.model.builder.BuilderBeanDto;
import org.example.manual.model.constructor.ConstructorBean;
import org.example.manual.model.constructor.ConstructorBeanDto;
...
public interface CustomMapper {
     ...
     *
     * Car를 CarDto로 변환해야 되는 상황인데,
     *
     * Car가 Person을 컴포지션으로 소유하고 있다.
     *
     * 이때 Car는 CarDto로 변환되며 Person을 PersonDto로 변환해야 한다.
     *
     * 이 경우에 어떻게 해야 하는가?
     */
